<template>
  ...
  >
    <div class="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
      <div
        class="relative z-30 mx-auto mt-18 h-30 w-full max-w-30 rounded-full bg-white/20 p-1 backdrop-blur sm:h-44 sm:max-w-44 sm:p-3"
      >
        <div class="relative drop-shadow-2">
          <img src="@/assets/images/user/Dr._jhojan.png" alt="profile" />
          <label
            for="profile"
      ...
      <div class="mt-4">
        <h3 class="mb-1.5 text-2xl font-medium text-black dark:text-white">jhojan Ballesteros</h3>
        <p class="font-medium">Dr. Vet</p>
        <div
